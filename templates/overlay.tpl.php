...
<div id="overlay" <?php print $attributes; ?>>
    ...
    <div id="overlay-content"<?php print $content_attributes; ?>>
      ...
      $menu_arr=menu_local_tasks();
      $current_root_path=$menu_arr['root_path'];

      if ($current_root_path == 'admin/config/system/mailjet/mailjet-panel') {
        if ($output_links_mailjet) {
          print "<br/>".$overlay_breadcrumb;
          ?>
            <br/><?php print $output_links_mailjet; ?></ul>
          <?php
        }
      }
      elseif ($current_root_path == 'admin/config/system/mailjet/signup-setttings') {
        print "<br/>".$overlay_breadcrumb;

        ?>
          <ul class="action-links"><?php print $action_links_signup; ?></ul><?php
        print $signup_forms;
      }
      else {
        print $page;
